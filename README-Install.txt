...
yum install -y httpd postgresql-server postgresql quagga net-snmp perl-Data-Validate-IP perl-NetAddr-IP perl-Email-MIME perl-Net-DNS perl-DBI perl-DBD-Pg perl-CGI perl-Config-Simple 
